...
import CookiesPolicyStyled from "./CookiesPolicyStyled";
  ...
  return (
    <CookiesPolicyStyled>
      ...
      <section className="cookies-policy__section">
        <p className="cookies-policy__intro">
        ...
        <h2 className="cookies-policy__section-title">Cookies propias</h2>
        <p className="cookies-policy__section-content">
          Son aquellas cookies que son enviadas al ordenador o dispositivo del
          Usuario y gestionadas exclusivamente por Llar Canina para el mejor
        ...
        <h2 className="cookies-policy__section-title">Cookies de terceros</h2>
        <p className="cookies-policy__section-content">
          Son cookies utilizadas y gestionadas por entidades externas que
          proporcionan a Llar Canina servicios solicitados por este mismo para
        ...
        <a
          ...
          className="cookies-policy__section-content"
        >
          Google Analytics
        </a>
        <p className="cookies-policy__section-content">
        ...
        <h2 className="cookies-policy__section-title">
          Cookies de redes sociales
        </h2>
        <p className="cookies-policy__section-content">
          Llar Canina incorpora plugins de redes sociales, que permiten acceder
          ...
          titulares de dichas redes sociales disponen de sus propias políticas
          de protección de datos y de cookies, siendo ellos mismos, en cada
          caso, responsables de sus propios ficheros y de sus propias prácticas
          de privacidad. El Usuario debe referirse a las mismas para informarse
